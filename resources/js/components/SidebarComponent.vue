        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img v-if="user.avatar != undefined && user.avatar != null" :src="'../storage/' + user.avatar" class="img-circle elevation-2" alt="User Image">
                        <img v-if="user.avatar != undefined && user.avatar === null" src="dist/img/avatar3.png" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
